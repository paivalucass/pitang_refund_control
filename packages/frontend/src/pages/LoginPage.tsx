...
export function LoginPage() {
  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-red-700 p-4">
      ...
      <div className="absolute left-[18%] top-[18%] hidden h-16 w-16 rounded-full border-8 border-white/10 lg:block" />
      <div className="absolute right-[22%] top-[28%] h-10 w-10 rounded-full bg-white/10" />
      <div className="absolute bottom-[20%] left-[12%] h-24 w-24 rounded-full border border-white/15" />
      <div className="absolute bottom-[12%] right-[32%] hidden h-14 w-14 rounded-full bg-white/10 md:block" />
      <div className="absolute left-[38%] top-8 h-8 w-8 rounded-full border border-white/20" />
